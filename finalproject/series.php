...
$stmt = $conn->prepare("SELECT id, title, score, image_path, genres, description, 
                       episodes, start_airing, anime_status, trailer_url, type
                       FROM animes WHERE type IN ('series', 'top')");
$stmt->execute();
...
<body>
    ...
    <main>
        <div class="page-header">
            ...
            <h1>All Anime Series</h1>
        </div>

        <div class="all-series-container" id="seriesContainer"></div>
