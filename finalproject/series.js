...
function initializeSeriesGrid() {
    const container = document.getElementById('seriesContainer');
    container.innerHTML = '';
    
    seriesData.forEach(series => {
        const isInWatchlist = user_watchlist.includes(parseInt(series.id));
...
function openAnimeModal(anime) {
    ...
    document.getElementById('modal-anime-animeStatus').textContent = anime.anime_status;
            ...
            <div class="comment-header">
                ...
                <div class="comment-rating">
                    ${Array(10).fill().map((_, i) => 
                        `<i class="fa-star ${i < comment.rating ? 'fa-solid' : 'fa-regular'}" 
